...
def main():
    fdir = '/home/upgp/jruebsam/simulations/mar16/week3/volfrac_validation/vpcase/data'
    ...
    plt.subplots_adjust(bottom=0.15, left=0.15, right=0.8)

    plt.savefig('mask_volpen.pdf')
