...
\begin{figure}%
    \centering
    \subfloat[label 1]{{\includegraphics{gfx/immersed_boundary/2_vp/vp_convergence.pdf} }}%
    \qquad
    \subfloat[label 2]{{\includegraphics{gfx/immersed_boundary/2_vp/vp_convergence.pdf} }}%
