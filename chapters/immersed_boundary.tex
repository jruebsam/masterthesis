...
\begin{figure}[!pt]
  \centering
  \includegraphics{gfx/immersed_boundary/hpflow/gc_theo/vp.pdf}\label{fig:hpflow_vpgc_theo}
  \caption{blabla}
\end{figure}

\begin{figure}[!pb]
  \centering
  \includegraphics{gfx/immersed_boundary/hpflow/gc_theo/df.pdf}\label{fig:hpflow_dfgc_theo}
  \caption{blabla}
\end{figure}
...
\begin{figure}[!pt]
  \centering
  \includegraphics{gfx/immersed_boundary/hpflow/gc_theo/ip.pdf}\label{fig:hpflow_ipgc_theo}
  \caption{blabla}
\end{figure}

\begin{figure}[!pb]
  \centering
  \includegraphics{gfx/immersed_boundary/hpflow/gc_theo/ip.pdf}\label{fig:hpflow_allgc_theo}
  \caption{blabla}
\end{figure}
