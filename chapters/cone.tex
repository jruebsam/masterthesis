...
Let us now consider the results of the frustum.
Above the critical slope $\alpha=\theta$ nearly all resonances are eliminated. One exception is the (\RN{4}) mode for
$h_+=0.5$ and $h_+=0.375$. Another exepction is at the position of the previous (\RN{1}) mode of the cone.
...
at the same frequency and same order as for the cone. To the left side of this point the spectrum for
