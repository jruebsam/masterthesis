...
into the cone apex.
A possible explanation is, that these wave rays are not reflected due damping effects in
the apex of the cone, as a results a downward traveling waves is observed.



for this behaviour would be that wave rays are traveling directly
into the apex of the cone




shows that this is not the exact case.

-we have a downward traveling wave at least it looks like thiss
- assumption

however this is difficu

-equivalent to the case from experiment



-ideat (\RN{8}) is related to (\RN{2})



By replacing the frustum with the cone it can seen that
...
Furthermore it can be seen that the i

-m8 mode looks similar hower the velocitiy profile indicates a downwoard traveling wave
- one assumpiton is that the wave is directly in the cone apex due to damping no reflection is possible
