...
\begin{figure}[!b]
  ...
  \caption{
      \label{fig:cone:decayphaseexample}
        Velocity profile for the decay in the cone for different times.
    }
\end{figure}
...
An explanation for the shift can be given by having a look at the inertial mode structure,
 for different radii as shown in Fig. \ref{fig:cone:phase}.\\
...
The velocity profiles furthermore shows that in the frustum inertial wave decay homogenously over the whole domain.
...
One example would be to investigate the decay of turbulence.

\subsubsection{Higher Resoltuion}

The resulting frequency spectra for the higher resolutions shows that
the default resolution of $\Delta x = \nicefrac{1}{128}$ yields
