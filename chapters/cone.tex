...
\begin{align}
    \mathcal{H} = \int_{V}\dif V  \vec{v} \cdot \left( \nabla \times \vec{v} \right)
\end{align}
...
\begin{align}
\mathcal{H}(t) = \frac{\int_V \dif V \vec{v} (\nabla \times \vec{v})}
...
Finally, Fig. \ref{fig:cone:decayphaseexample} shows the velocity profile for different times, during the decay in
