...
in the first part of the chapter a simulation of cylinder was carried out
in order to  compare the results to available theoretical and numerical soultios.

All methods are able to reproduce these features
-ausser ip

-aber auch probleme zum beispiel numerische oszillation
