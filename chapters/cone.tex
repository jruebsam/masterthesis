...
All methods which were used show a similar spectrum.
The largest deviations can be recognized at a frequency of $\omega=0.8$ and are of the order $\approx2\cdot10^{-3}$.
The spectrum contains of a large resonance at the position $\omega=1.2$ of the order $\approx3.5\cdot10^{-2}$, followed by two
...
The remaining methods are slighty diminished, to the one mentioned before but no strict order can be determined.
