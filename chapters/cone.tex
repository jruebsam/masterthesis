...
The peaks in the frequency spectrum can be identified as inertial modes.
...
This value gives a possible explanation for the occurrence of oscillations,
...
In this area the amplitudes increase,  accordance with the
...
This would be in in accordance with the previous results and
...
The position of the bottom plate is than $0.375$ and the resulting frustum height is $H=0.625$.
...
On the left side of the critical frequecy $\omega_c$,  the M\RN{3}-peak can be identified
...
This is probably a result of the step size $\Delta \omega = 0.05$, therefore the exact position of $\omega_\text{min}$ and M\RN{3} is not given.
...
The velocity profiles furthermore show that in the frustum the inertial mode decays homogeneously over the whole domain.
...
The simulation furthermore showed that inertial modes in the frustum exist.
