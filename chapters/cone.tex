...
-observation in pressure and phase indicates
-than bottom plate  expectation etc
-results
...
the liberation amplitude to zero.
...
to make sure that for all frequencies the liberating force drops out when crossing zero.
The main simulation parameters are given by
...
\subsubsection{Simulation with no Liberation}
