...
while the width of an inertial wave ray can be estimated to $\Ekman^{\nicefrac{1}{3}}\approx 0.046$, according to \citep{ATPAPER???}.
...
the apex of the cone. As a result, a downward traveling waves is observed.
However, with this approach we are still not able to explain the resonance of the peak M\RN{8},
in the spectrum.
...
\begin{figure}[!t]
  ...
  \begin{minipage}[c]{0.5\textwidth}
      \caption{\label{fig:conediscuss:corners}
        ...
        for a wave ray with a frequency at the minimum close to peak (\RN{6}) (red) and
...
of the minimum in the spectrum at the left side of the peak M\RN{6}.
