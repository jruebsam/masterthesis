...
-ziel spectrum to show resonances
...
Figure \ref{fig:cone:cyl} shows the frequency spectrum of the libration frequency $\omega$.(NEUSCHREIBEN).
For all methods which were used similar curves can be seen.....(NEUSCHREIBEN).
The spectrum contains a large resonance peak at $\omega\approx 1.2$ and two
smaller ones at $\omega\approx0.75$ and $\omega\approx1.7$.\\
- the differences for some of the methods are small\\
- exemplarly we provide an inset for w1.1 etc\\
- we can seee in genearl dfo2 vpo2 and vpo4 er similar\\
- for all other methods a slight decreas in A exists\\
- dt results in nearly no difference for vp and df\\
- the largest offset can be observed around  at w=1.5 and is of the order $10^-2$.\\
