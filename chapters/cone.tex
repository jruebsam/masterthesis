...
-gradient a the borde
-this is in accordance with the upwinding
-peclet number ausrechnen >10!
-problem small ekmann numbers

\subsubsection{Numerical Viscosity}
-numerical viscosity
-the idea was to see if the numercial viscosity is larger than the viscosity of ek
-good results

\subsubsection{Helicity}
-helic ist 0 due to the symetrie der anregung
...
This is a little bit of a disappointing results, since this methods
