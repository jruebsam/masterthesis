...
The numerical solution  however, can be very time consuming is and furthermore difficult to implement on a GPU \footnoteref{notepc_arti}.
...
is small, a good estimation is $\Mach<0.1$ \footnote{\label{notepc_arti}Private Communication A.Tilgner}.
