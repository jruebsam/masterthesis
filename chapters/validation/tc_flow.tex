...
\paragraph{Velocity error profiles}\mbox{}\\
...
-in figt blabla
-it can be seen that  comparsion maximum difference

\subsubsection{Long-Term Simulations}

The long-term simulations were performed to test the numerical-stability and the conservation of mass.
For all methods, except the IP-DF4 method, these simulation were numerically stable.
The density was averaged of the fluid domain by Eq.  \ref{vali:density_calc}

-the denisiy fluctuates for both DF2 and DF4.
Furthermore for both cases oscillation can be observed.
