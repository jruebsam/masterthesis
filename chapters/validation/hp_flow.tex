...
In \citep{FADLUN} the Direct forcing method was tested and compared to
a linear interpolation method similar to ours.
Yy  computing the formation of a vortex ring created by an

comparison

A test of the interpolation method can be found in \citep{}, \citep{}.
